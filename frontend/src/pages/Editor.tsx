                ...
                <div className="flex gap-3 w-full sm:w-auto">
                    ...
                    <button
                        onClick={() => {
                            if (!showTerminal) {
                                setShowTerminal(true);
                                // Defer execution slightly to allow terminal mount
                                setTimeout(() => {
                                    if (terminalRef.current) {
                                        terminalRef.current.uploadFile('Script.ps1', code);
                                        // Wait a bit for upload to process (usually instant on local, but good to be safe)
                                        setTimeout(() => {
                        ...
                        className="flex-1 sm:flex-none px-4 py-2 rounded-lg bg-teal-600 hover:bg-teal-700 text-white transition flex items-center justify-center gap-2"
                        title="Uploads script as file and executes it (safer for complex scripts)"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
